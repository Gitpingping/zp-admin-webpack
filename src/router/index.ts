...
// 登录
const Login = () => import('../views/no-permission/login')
// 看板
const DashBoard = () => import('../views/permission/board/dash-board')
// 用户列表
const UserList = () => import('../views/permission/user/user-list')
// 404
const NoPage = () => import('../views/no-permission/404')
